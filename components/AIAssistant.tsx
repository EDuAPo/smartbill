...
const AIAssistant: React.FC<Props> = ({ user, transactions, monthlyBudget, onAdd, showNotify }) => {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden bg-black">
      ...
      {/* Chat Bar */}
      <div className="px-4 pb-4 pt-2 z-40 bg-gradient-to-t from-black via-black to-transparent">
        <div className="relative">
          {showPlusMenu && (
            <div className="absolute bottom-full left-0 right-0 mb-3 glass rounded-[32px] p-3 flex gap-3 animate-in slide-in-from-bottom-4 duration-300">
